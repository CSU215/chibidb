...
> 最后更新：P10/P7/P8、P2+、P3 全部完成（含认证权限与 `information_schema`）；457 tests 全绿、clippy 零警告。
...
提交基线：`b877b7a feat: expose instance metadata through a virtual information_schema`（HEAD）。
