...
> 最后更新：P10 + P7 + P8 完成；P3 认证/权限强制 + P2+ `TransactionManager` 落地；454 tests 全绿、clippy 零警告。
...
提交基线：`3153593 refactor: extract the transaction manager from the database`（HEAD）。
