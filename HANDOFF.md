...
> 最后更新：P10 完成 + P7.1 接缝 + P7.2 MemTable + P7.3 块/SSTable/bloom + P7.4a LSM store；420 tests 全绿、clippy 零警告。
...
提交基线：`f276b21 feat: add the in-memory LSM store with flush and compaction`（HEAD）。
