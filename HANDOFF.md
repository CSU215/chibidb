...
> 最后更新：P10 完成 + P7.1 存储引擎接缝 + P7.2 LSM MemTable；399 tests 全绿、clippy 零警告。
...
提交基线：`b336985 feat: add the LSM memtable write buffer`（HEAD）。
