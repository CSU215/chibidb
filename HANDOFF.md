...
> 最后更新：P10 完成 + P7.1 接缝 + P7.2/3/4 LSM 存储 + P7.5a LsmEngine；429 tests 全绿、clippy 零警告。
...
提交基线：`105312a feat: add an LSM TableStorage engine keyed by row id`（HEAD）。
