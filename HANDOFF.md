...
> 最后更新：P10/P7/P8/P2+/P3 + P9（HTTP+MySQL 含预处理）+ LSM 分级压实/流式；474 tests 全绿、clippy 零警告。
...
提交基线：`96d36b5 perf: level LSM sstables and cascade compaction across levels`（HEAD）。
