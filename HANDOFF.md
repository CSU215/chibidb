...
> 最后更新：重构 P0/P1 完成；P2 存储读接口、Protocol 编解码、Stage 流水线三个接缝落地；321 tests 全绿、clippy 零警告。
...
提交基线：`9c5199a feat: add Stage/Pipeline seam and run statements through it`（HEAD）。
