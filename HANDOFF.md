...
> 最后更新：P10 完成 + P7.1 接缝 + P7.2 MemTable + P7.3a 块格式；405 tests 全绿、clippy 零警告。
...
提交基线：`45d1c6f feat: add the LSM block format and coding`（HEAD）。
