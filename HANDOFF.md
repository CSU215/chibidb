...
> 最后更新：P10 完成 + P7.1 接缝 + P7.2 MemTable + P7.3 块/SSTable/bloom + P7.4 持久化 LSM；426 tests 全绿、clippy 零警告。
...
提交基线：`e1ac224 feat: persist the LSM store with a manifest`（HEAD）。
