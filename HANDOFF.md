...
> 最后更新：P10 完成 + P7 全部（Heap/LSM 双引擎 + 配置选择 + WAL 路由）；431 tests 全绿、clippy 零警告。
...
提交基线：`25617a5 feat: select the table engine from config and route WAL replay by engine`（HEAD）。
