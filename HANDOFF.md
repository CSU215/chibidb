...
> 最后更新：P10 完成 + P7 全部（双引擎）+ P8 外存 LOB（编解码接入）；441 tests 全绿、clippy 零警告。
...
提交基线：`caef3e6 feat: externalize long strings to the LOB store in row encoding`（HEAD）。
