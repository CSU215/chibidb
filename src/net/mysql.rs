...
fn handle_query(
    ...
    if let Ok(stmts) = crate::sql::parser::parse(&sql)
...
fn is_transaction_control(stmt: &crate::sql::ast::Stmt) -> bool {
    matches!(stmt, crate::sql::ast::Stmt::Trx(_))
}
    ...
    crate::is_exclusive(stmt)
        || matches!(
            ...
            crate::sql::ast::Stmt::CreateDatabase(_)
                | crate::sql::ast::Stmt::DropDatabase(_)
                | crate::sql::ast::Stmt::Use(_)
                | crate::sql::ast::Stmt::CreateUser(_)
                | crate::sql::ast::Stmt::DropUser(_)
                | crate::sql::ast::Stmt::Grant(_)
                | crate::sql::ast::Stmt::Revoke(_)
                | crate::sql::ast::Stmt::Login(_)
        )
}
